...
**"Todo — Las Ensenanzas" (todo.eluno.org)** — Version gentil y accesible del Material Ra condensada en 11 capitulos. Una invitacion a recordar — sabiduria ancestral para buscadores modernos, presentada como historia eterna. Idioma base EN, traduccion a ES y PT. Autorizado por L/L Research, 10 Enero 2026.
...
- **Ciencia/filosofia:** Integrar donde sea natural. NUNCA contradecir a Ra. NUNCA forzar conexiones.
...
Este libro escribe las ensenanzas de Ra desde su voz. Eso se hace explicito cuando el mensaje mira a la Tierra desde fuera o comunica algo que excede el alcance humano ordinario. Pero NO es necesario hacerlo explicito en cada tema que se presenta.

El proposito del libro, ademas de presentar la informacion, es ayudar a que las personas puedan *recibirla*. No es facil recibir una cosmologia proveniente de fuentes extraterrestres. En la Tierra, la proteccion mas efectiva contra el tema UFO fue etiquetarlo de ridiculo en la opinion publica. Esto genera intrinsecamente un rechazo — incluso inconsciente — en cualquier ser humano hacia cualquier mensaje con esa procedencia.
...
- Mal: "lo que vuestros cientificos han descubierto..." (marca otredad innecesaria)
- Bien: "lo que los cientificos han descubierto..." (mismo mensaje, sin barrera)

Este libro sera leido en la Tierra. Decir "los cientificos" en lugar de "vuestros cientificos" no altera en nada la ensenanza. Pero elimina una barrera que podria impedir que el lector la reciba.
...
- Cuando la perspectiva "nosotros/ustedes" ES el mensaje (por ejemplo, al hablar de la Confederacion observando la cosecha de la Tierra)
...
| `{ref:category:id}` | Conexion natural con ciencia/filosofia/tradiciones | Si |
...
- Correcto: `{term:free-will}`, `{term:energy-centers}`, `{term:higher-self}`
- Incorrecto: `{term:free will}`, `{term:Energy Centers}`, `{term:Higher Self}`

---

## NOTAS DE TRADUCCION (EN -> ES)

### Terminologia especifica

| Ingles | Espanol correcto | Espanol incorrecto | Nota |
|--------|-----------------|-------------------|------|
| density | densidad | dimension | NUNCA "dimension" |
| catalyst | catalizador | problema, desafio | Mantener termino Ra |
| harvest | cosecha | juicio, rapto | Sin connotacion religiosa |
| Wanderer | errante | starseed | "Starseed" solo en nota explicativa |
| energy center | centro de energia | chakra | Solo en primera explicacion |
| distortion | distorsion | error, alteracion | Termino tecnico especifico |
| mind/body/spirit complex | complejo mente/cuerpo/espiritu | persona (en contexto tecnico) | Termino Ra completo |
| the Creator | el Creador | Dios | NUNCA "Dios" |
| free will | libre albedrio | — | |
| the Choice | la Eleccion | — | Capitalizado |
| Intelligent Infinity | Infinito Inteligente | — | Capitalizado |
| Intelligent Energy | Energia Inteligente | — | Capitalizado |

### "Logoi" -> espanol: usar "los Logos"

En ingles, "Logoi" es aceptable. Pero en espanol, el plural de Logos es **"Logos"** invariable: "los Logos", "cada uno de los Logos". NUNCA "Logoi".

### Terminologia EN -> PT

| English | Portugues | Nota |
|---------|-----------|------|
| density | densidade | |
| harvest | colheita | |
| Wanderer | errante | Misma palabra |
...
### Fase 2 — Escritura EN
- Escribe el capitulo completo en ingles
...
- Estructura identica a los capitulos existentes en `i18n/en/chapters/`

#### B) `glossary.json` — Glosario del capitulo
```json
[
  {
    "keyword": "infinite-creator",
    "title": "The Infinite Creator",
    "definition": "..."
  }
]
```
Cada definicion debe leerse independientemente del capitulo.
Titulos en minuscula por defecto. Solo mayuscula en nombres propios (Infinite Creator, Higher Self, Logos).
      ...
      "segments": [
        {
          ...
          "note": "Brief description of the concept"
        }
      ]
    }
  ]
...
**Nota:** La traduccion a ES y PT se ejecuta con Sonnet en Claude Code.
...
- Ciencia/filosofia integrada donde sea natural, no forzada
- La prosa debe ser bella sin ser pretenciosa
- Tono gentil e invitador — este es el libro de entrada
...
- Mas accesible que eluno — menos densidad conceptual por parrafo

---

## PUBLICACION DE FUENTES

Este sistema de prompts se publicara junto al libro como parte de la documentacion del proyecto. Las fuentes originales y sus enlaces:
